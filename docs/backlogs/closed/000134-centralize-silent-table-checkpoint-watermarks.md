...
- Type: implemented
- Detail: Implemented via docs/tasks/000199-catalog-silent-table-replay-watermarks.md
- Closed By: backlog close
- Reference: docs/tasks/000199-catalog-silent-table-replay-watermarks.md
