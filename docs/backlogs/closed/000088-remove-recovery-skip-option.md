...
- Type: implemented
- Detail: Implemented via docs/tasks/000123-remove-recovery-skip-option.md.
- Closed By: backlog close
- Reference: docs/tasks/000123-remove-recovery-skip-option.md; GitHub issue #568; PR #569
