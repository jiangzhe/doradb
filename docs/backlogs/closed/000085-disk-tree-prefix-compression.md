...
- Type: implemented
- Detail: Implemented via task 000122 DiskTree Prefix Compression
- Closed By: backlog close
- Reference: docs/tasks/000122-disk-tree-prefix-compression.md; docs/rfcs/0014-dual-tree-secondary-index.md
