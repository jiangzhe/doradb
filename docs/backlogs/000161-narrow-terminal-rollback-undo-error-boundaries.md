...
docs/tasks/000228-typed-infrastructure-error-boundaries.md; docs/rfcs/0023-storage-error-boundary-propagation-migration.md Phase 3
...
- Findings: Completion publication now accepts an owned Fatal report, but rollback_inner builds that report from the crate public Error returned by index and row undo rollback. This retains diagnostic frames yet leaves ErrorKind as an internal transport frame and is not the final monotonic design.
