...
Data persistence (Data Checkpoint), deletion persistence (Deletion Checkpoint), and Index persistence (Index Checkpoint) are independent processes. They coordinate only at the final commit phase to update the SuperPage atomically.
