...
pub struct TransactionSystem {
    ...
    group_commit_v4: CachePadded<Mutex<GroupCommit>>,
...
impl TransactionSystem {
    ...
    #[inline]
    pub async fn commit_v4(&self, trx: ActiveTrx) {
        ...
        // start group commit
        let mut group_commit_g = self.group_commit_v4.lock();
    ...
    #[inline]
    pub fn group_commit_stats_v4(&self) -> GroupCommitStats {
        self.group_commit_v4.lock().stats
    }
    ...
    fn new() -> Self {
        TransactionSystem {
            ...
            group_commit_v4: CachePadded::new(Mutex::new(GroupCommit::new())),
...
mod tests {
    ...
    fn test_transaction_system() {
        let trx_sys = TransactionSystem::new_static();
        {
            ...
            smol::block_on(trx_sys.commit_v4(trx));
        }
        std::thread::spawn(|| {
            let trx = trx_sys.new_trx();
            smol::block_on(trx_sys.commit_v4(trx));
    ...
    fn test_trx_sys_group_commit() {
        ...
        trx_sys.start_gc_thread();
        {
            ...
            smol::block_on(trx_sys.commit_v4(new_trx));
        }
