...
impl<'a> ColumnBlockIndex<'a> {
    ...
    fn update_subtree_with_patches<'b, M: MutableCowFile + 'b>(
        &'b self,
    ...
    async fn update_leaf_with_patches<M: MutableCowFile>(
        &self,
        mutable_file: &mut M,
        page_id: PageID,
    ...
    async fn update_branch_with_patches<M: MutableCowFile>(
        &self,
        mutable_file: &mut M,
        page_id: PageID,
        node: &ColumnBlockNode,
