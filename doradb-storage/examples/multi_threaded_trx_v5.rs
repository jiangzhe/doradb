...
use doradb_storage::trx::sys_v5::{RedoLogger, TransactionSystem};
...
fn main() {
    ...
    if let Some(log_file) = &args.log_file {
        let logger = NormalRedoLogger::new(log_file, args.log_len_threshold * 2);
    ...
    }
    {
        ...
        let stats = trx_sys.group_commit_stats_v5();
