...
mod tests {
    ...
    /// Purpose: Validate managed-binding results and cleanly drain cancelled resolution work.
    /// Expected: Invalid bindings are rejected and cancellation leaves no recorded work or
    /// leaked session state.
    #[test]
