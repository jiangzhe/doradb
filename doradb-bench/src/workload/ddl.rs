...
mod tests {
    ...
    /// Purpose: Keep benchmark index definitions faithful to the selected index mode.
    /// Expected: Modes produce the intended absence or uniqueness policy without declaring
    /// primary keys.
    #[test]
